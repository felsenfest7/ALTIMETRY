...
#Excel tabloları
envisat_aylik_veriler_excel = rmn.df2excel(idw_envisat, "ALES", "IGNEADA", "igneada_ales_envisat_idw")
jason_aylik_veriler_excel = rmn.df2excel(idw_jason, "ALES", "IGNEADA", "igneada_ales_jason_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik(idw_envisat, idw_jason, "İğneada Aylık Ağırlıklandırılmış Altimetre Verileri")
