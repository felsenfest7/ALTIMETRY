...
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/MARMARA_EREGLISI/MARMARA_EREGLISI_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
...
ort_koordinatlar_jason = rmn.ort_koord(hesaba_girecek_veriler_jason, 10)
...
#Excel tabloları
envisat_aylik_veriler_excel = rmn.df2excel(idw_envisat, "ALES", "MARMARA_EREGLISI", "merg_ales_envisat_idw")
jason_aylik_veriler_excel = rmn.df2excel(idw_jason, "ALES", "MARMARA_EREGLISI", "merg_ales_jason_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik(idw_envisat, idw_jason, "Marmara Ereğlisi Aylık Ağırlıklandırılmış Altimetre Verileri")
