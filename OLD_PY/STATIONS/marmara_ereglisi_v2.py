...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(filtered_idw_ales, "ALES2", "MARMARA_EREGLISI", "marmara_ereglisi_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Marmara Ereğlisi Aylık Altimetre Verileri")

pr.distance_plot(filtered_idw_ales, 40.96896672, 27.96215236, enlem_ales, boylam_ales, "Marmara Ereğlisi")
