...
#Jason1'i ayırmak için
ales_jason1 = ales_jason1[ales_jason1["cdate_t"] < "2009-01-01"]
...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 23.90]

#Zamansal olarak interpolasyonların yapılması
filtered_idw_ales = af.dates_interpolation(filtered_idw_ales)

#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(filtered_idw_ales, "ALES2", "TRABZON", "trabzon_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Trabzon Aylık Altimetre Verileri")

pr.distance_plot(filtered_idw_ales, 41.001978, 39.74454939, enlem_ales, boylam_ales, "Trabzon")
