...
#MARMARİS ALES
#Verinin okunması
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/MARMARİS/MARMARİS_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
...
#Excel tabloları
envisat_aylik_veriler_excel = rmn.df2excel(idw_envisat, "ALES", "MARMARİS", "marmaris_ales_envisat_idw")
jason_aylik_veriler_excel = rmn.df2excel(idw_jason, "ALES", "MARMARİS", "marmaris_ales_jason_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik(idw_envisat, idw_jason, "Marmaris Aylık Ağırlıklandırılmış Altimetre Verileri")
