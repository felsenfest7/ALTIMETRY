...
#MENTES ALES
#Verinin okunması
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/MENTES/MENTES_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
...
#Excel tabloları
envisat_aylik_veriler_excel = rmn.df2excel(idw_envisat, "ALES", "MENTES", "mentes_ales_envisat_idw")
jason_aylik_veriler_excel = rmn.df2excel(idw_jason, "ALES", "MENTES", "mentes_ales_jason_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik(idw_envisat, idw_jason, "Menteş Aylık Ağırlıklandırılmış Altimetre Verileri")
