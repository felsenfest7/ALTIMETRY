...
#YALOVA ALES
#Verinin okunması
ales_envisat = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/YALOVA/YALOVA_VERİLER/ENVISAT/ENVISAT_DATA/*.nc")
...
#Excel tabloları
envisat_aylik_veriler_excel = rmn.df2excel(idw_envisat, "ALES", "YALOVA", "yalova_ales_envisat_idw")
jason_aylik_veriler_excel = rmn.df2excel(idw_jason, "ALES", "YALOVA", "yalova_ales_jason_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik(idw_envisat, idw_jason, "Yalova Aylık Ağırlıklandırılmış Altimetre Verileri")
