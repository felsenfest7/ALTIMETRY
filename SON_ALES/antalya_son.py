...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 25.90]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 25.40]
...
#Excele aktarılması
wish_table = af.df2excel3(wish, "ALES3", "ANTALYA", "antalya_ssh_weight.xlsx")
