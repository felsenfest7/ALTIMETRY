...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 38.50]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 38.85]
...
#Excele aktarılması
wish_table = af.df2excel3(wish, "ALES3", "ERDEK", "erdek_ssh_weight.xlsx")
