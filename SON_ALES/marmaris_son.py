...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 24.80]
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 25.30]
...
#Excele aktarılması
wish_table = af.df2excel3(wish, "ALES3", "MARMARİS", "marmaris_ssh_weight.xlsx")
