...
#Excel tabloları
#ales_aylik_veriler_excel = af.df2excel(filtered_idw_ales, "ALES2", "ANTALYA", "antalya_ales_aylik_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Antalya Aylık Altimetre Verileri")

#pr.distance_plot(filtered_idw_ales, 36.83042146, 30.60868263,  enlem_ales, boylam_ales, "Antalya")
