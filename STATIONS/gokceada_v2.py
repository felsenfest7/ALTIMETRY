...
ales_jason1 = af.index_sec(ales_jason1, 8)
ales_jason2 = af.index_sec(ales_jason2, 8)
ales_jason3 = af.index_sec(ales_jason3, 8)

#Veriye filter uygulanması
ales_jason1 = af.filter_ales_05(ales_jason1)    # 30 veriden 28 tanesi kullanılabiliyor
...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] < 40.58]

#Zamansal olarak interpolasyonların yapılması
filtered_idw_ales = af.dates_interpolation(filtered_idw_ales)

#Excel tabloları
#ales_aylik_veriler_excel = af.df2excel(filtered_idw_ales, "ALES2", "GOKCEADA", "gokceada_ales_aylik_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Gökçeada Aylık Altimetre Verileri")

#pr.distance_plot(filtered_idw_ales, 40.23171234, 25.89349329, enlem_ales, boylam_ales, "Gökçeada")
