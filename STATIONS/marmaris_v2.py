...
#Excel tabloları
#ales_aylik_veriler_excel = af.df2excel(filtered_idw_ales, "ALES2", "MARMARİS", "marmaris_ales_aylik_idw")

#Verilerin çizdirilmesi
#aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Marmaris Aylık Altimetre Verileri")

#pr.distance_plot(filtered_idw_ales, 36.84867631, 28.28226596, enlem_ales, boylam_ales, "Marmaris")
