...
#SİNOP ALES
#Verinin okunması
ales_jason1 = rmn.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/SİNOP/SİNOP_VERİLER/JASON1/JASON1_DATA/*.nc")
...
ales_jason1 = af.filter_ales_05(ales_jason1)    # 121 veriden 114 tanesi kullanılabiliyor
ales_jason2 = af.filter_ales_05(ales_jason2)    # 278 veriden 261 tanesi kullanılabiliyor
ales_jason3 = af.filter_ales_05(ales_jason3)    # 92 veriden 85 tanesi kullanılabiliyor
...
filtered_idw_ales = filtered_idw_ales[filtered_idw_ales["ssh_idw"] > 29.30]

#Zamansal olarak interpolasyonların yapılması
filtered_idw_ales = af.dates_interpolation(filtered_idw_ales)

#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(filtered_idw_ales, "ALES2", "SİNOP", "sinop_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_ales, "Sinop Aylık Altimetre Verileri")

pr.distance_plot(filtered_idw_ales, 42.02306816, 35.14945865 , enlem_ales, boylam_ales, "Sinop")
