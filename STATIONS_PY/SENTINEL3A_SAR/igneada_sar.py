...
#gel_aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_gel, "İğneada SAR Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf_gel(filtered_idw_gel)

#Excele aktarılması
wish_table = af.df2excel3(wish, "ALES3", "IGNEADA", "igneada_sar_ssh_weight")

haa = ha.harmonik_analiz2(wish, "İğneada SAR", "igneada", "sar")
print(haa)
