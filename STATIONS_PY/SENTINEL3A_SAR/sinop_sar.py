...
#-----------------------------------------------------------------------------------------------------------------------
#SİNOP GELENEKSEL VERİLER
#Verinin okunması
gel_s3a = rmn.merge_nc_ssh("/home/furkan/deus/ALTIMETRY/processler/SSH_VERİLERİ/SİNOP/SİNOP_VERİLER/SENTINEL3A/SENTINEL3A_DATA/*.nc")
...
#gel_aylik_ssh_plot = pr.plot_ssh_aylik_yeni(filtered_idw_gel, "Sinop SAR Altimetre Verileri")

#nx3'lük matrisin oluşturulması
wish = af.df2newdf_gel(filtered_idw_gel)

#Excele aktarılması
wish_table = af.df2excel3(wish, "ALES3", "SİNOP", "sinop_sar_ssh_weight")

haa = ha.harmonik_analiz2(wish, "Sinop SAR", "sinop", "sar")
print(haa)
