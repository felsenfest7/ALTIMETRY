...
%GOKCEADA'YA AİT VERİLER

ales_veriler = readtable("/home/furkan/deus/ALTIMETRY/processler/ALES2/GOKCEADA/gokceada_ales_aylik_idw.xlsx");
...
title("Gökçeada Aylık ALES Verilerinin Dağılımları");
legend();
grid on;
...
ales_lat_ort = 40.28046929973475;
ales_lon_ort = 26.172972952254643;
