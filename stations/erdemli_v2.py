...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(idw_ales, "ALES2", "ERDEMLİ", "erdemli_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(idw_ales, "Erdemli Aylık Altimetre Verileri")

# ortalama enlem = 36.48071345508981
# ortalama boylam = 34.41537598802395
