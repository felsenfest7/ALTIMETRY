...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(idw_ales, "ALES2", "GOKCEADA", "gokceada_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(idw_ales, "Gökçeada Aylık Altimetre Verileri")

# ortalama enlem = 40.28046929973475
# ortalama boylam = 26.172972952254643
