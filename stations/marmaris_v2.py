...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(idw_ales, "ALES2", "MARMARİS", "marmaris_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(idw_ales, "Marmaris Aylık Altimetre Verileri")

# ortalama enlem = 36.753829885245906
# ortalama boylam = 28.57312370765027
