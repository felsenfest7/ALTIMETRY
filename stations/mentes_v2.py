...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(idw_ales, "ALES2", "MENTES", "mentes_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(idw_ales, "Menteş Aylık Altimetre Verileri")

# ortalama enlem = 38.6954301462585
# ortalama boylam = 26.572793914965985
