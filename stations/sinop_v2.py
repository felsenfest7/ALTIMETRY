...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(idw_ales, "ALES2", "SİNOP", "sinop_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(idw_ales, "Sinop Aylık Altimetre Verileri")

# ortalama enlem = 42.034889160493826
# ortalama boylam = 34.67954159259259
