...
#TRABZON ALES
#Verinin okunması
ales_jason1 = af.merge_nc("/home/furkan/deus/ALTIMETRY/processler/ALES/TRABZON/TRABZON_VERİLER/JASON1/JASON1_DATA/*.nc")
...
ales_jason1 = af.index_sec(ales_jason1, 1)
ales_jason2 = af.index_sec(ales_jason2, 1)
ales_jason3 = af.index_sec(ales_jason3, 1)

#Veriye filter uygulanması
ales_jason1 = af.filter_ales_05(ales_jason1)    # 228 veriden 116 tanesi kullanılabiliyor
ales_jason2 = af.filter_ales_05(ales_jason2)    # 278 veriden 90 tanesi kullanılabiliyor
ales_jason3 = af.filter_ales_05(ales_jason3)    # 92 veriden 57 tanesi kullanılabiliyor
...
#Excel tabloları
ales_aylik_veriler_excel = af.df2excel(idw_ales, "ALES2", "TRABZON", "trabzon_ales_aylik_idw")

#Verilerin çizdirilmesi
aylik_ssh_plot = pr.plot_ssh_aylik_yeni(idw_ales, "Trabzon Aylık Altimetre Verileri")

# ortalama enlem = 41.07566573737373
# ortalama boylam = 39.758317353535354
